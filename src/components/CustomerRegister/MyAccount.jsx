                            ...
                            <div className="card-block">
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        ...
                                        <h6 className="text-muted f-w-400">Aish</h6>
                                    </div>
                                    <div className="col-sm-6">
                                        <p className="m-b-10 f-w-600">Email</p>
                                        <h6 className="text-muted f-w-400">aih12@gmail.com</h6>
                                    </div>
                                    <div className="col-sm-6">
                                        <p className="m-b-10 f-w-600">Phone Number</p>
                                        <h6 className="text-muted f-w-400">9876551234</h6>
                                    </div>
                                    <div className="col-sm-6">
                                        <p className="m-b-10 f-w-600">Address</p>
                                        <h6 className="text-muted f-w-400">Chakrapath</h6>
                                    </div>
                                </div>
                            </div>
                        </div>
